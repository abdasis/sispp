...
<head>
    ...
    <!-- App css -->
    <link
        href="{{asset('assets/css/config/material/bootstrap.min.css')}}"
        rel="stylesheet"
        type="text/css"
        id="bs-default-stylesheet"
    />
    <link
        href="{{asset('assets/css/config/material/app.min.css')}}"
        rel="stylesheet"
        type="text/css"
    ...
    <link
        href="{{asset('assets/css/config/material/bootstrap-dark.min.css')}}"
        rel="stylesheet"
        type="text/css"
        id="bs-dark-stylesheet"
    />
    <link
        href="{{asset('assets/css/config/material/app-dark.min.css')}}"
        rel="stylesheet"
        type="text/css"
        ...
        <div class="tab-content pt-0">
            <div class="tab-pane" id="chat-tab" role="tabpanel">
                ...
                <div class="p-2">
                    ...
                    >
                        <i
                            class="mdi mdi-checkbox-blank-circle-outline me-1 text-success"
                        ></i>
                    ...
                    >
                        <i
                            class="mdi mdi-checkbox-blank-circle-outline me-1 text-warning"
                        ></i>
                    ...
                    >
                        <i
                            class="mdi mdi-checkbox-blank-circle-outline me-1 text-danger"
                        ></i>
                ...
                <h6 class="fw-medium px-3 mt-3 text-uppercase">
                    ...
                    ><i class="float-end mdi mdi-plus-circle"></i
                        ></a>
                </h6>
